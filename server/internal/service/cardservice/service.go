...
func New(repo repository.Cards) service.CardService {
	return &Service{
		repo: repo,
	}
}

func (s *Service) Create(ctx context.Context, item *model.CardData) error {
	err := s.repo.Create(ctx, item)
	return err
}

func (s *Service) Update(ctx context.Context, item *model.CardData) error {
...
func (s *Service) Get(ctx context.Context, id int) (*model.CardData, error) {
...
func (s *Service) GetUserData(ctx context.Context, userID int) ([]model.CardData, error) {
